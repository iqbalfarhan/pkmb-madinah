...
const AbsentFilterSheet: FC<Props> = ({ children }) => {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          <SheetTitle>Filter absent</SheetTitle>
          <SheetDescription>Filter data absent</SheetDescription>
        </SheetHeader>
...
export default AbsentFilterSheet;
