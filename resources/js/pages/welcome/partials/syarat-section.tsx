      ...
      <Card>
        <CardContent>
          <article className={cn('prose prose-lg min-w-full', appearance != 'light' && 'prose-invert')}>
            ...
            <p>
              Semua dokumen wajib berformat JPG/PNG atau PDF dan ukuran file maksimal 2MB per dokumen. Pastikan dokumen terlihat jelas, tidak blur
              atau gelap, agar bisa diverifikasi dengan mudah oleh panitia. Gunakan email aktif dan nomor WhatsApp yang valid saat pendaftaran, karena
