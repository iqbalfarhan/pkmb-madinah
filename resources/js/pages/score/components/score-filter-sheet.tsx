...
const ScoreFilterSheet: FC<Props> = ({ children }) => {
        ...
        <ScrollArea className="flex-1 overflow-y-auto">
          ...
          >
            <FormControl label="Nama Score">
              <Input type="text" placeholder="Name score" value={data.name} onChange={(e) => setData('name', e.target.value)} />
            </FormControl>
          </form>
        </ScrollArea>
        <SheetFooter>
