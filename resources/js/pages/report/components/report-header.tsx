...
const ReportHeader = () => {
  ...
  const label = {
    ...
    'doa-hadist': "LAPORAN PERKEMBANGAN HAFALAN BACAAN DO'A HARIAN DAN HADITS",
    'praktik-sholat': 'LAPORAN PERKEMBANGAN GERAKAN DAN BACAAN SHOLAT',
    'adzan-wudhu': 'LAPORAN PERKEMBANGAN HAFALAN PRAKTEK ADZAN DAN TATA CARA WUDHU',
  } as const;
